<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPrincipal.Master" AutoEventWireup="true" CodeBehind="ListarArticulo.aspx.cs" Inherits="TpFinalNivel3_Arteaga_Ponssa_Lucas.ListarArticulo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="mb-3">
        <asp:GridView ID="dgvArticulos" runat="server" CssClass="table"
            ...
            OnPageIndexChanging="dgvArticulos_PageIndexChanging" AllowPaging="true" PageSize="4" data-bs-theme="dark">
            <Columns>
